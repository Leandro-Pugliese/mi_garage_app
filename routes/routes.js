...
router.post('/vehicle/transfer/send/:id', isPremium, sendTransferVehicle);
router.get('/vehicle/transfer/data/:token', isAuthenticated, getDataTransfer);
router.put('/vehicle/transfer/:token', isAuthenticated, acceptTransferVehicle);
router.put('/vehicle/transfer/cancel/:id', isAuthenticated, cancelTransferVehicle);
